...
const deck1: DeckDefinition = {
  ...
  cardIds: [
    ...
    'creature_red_003',     // 吸血刺客       (3hp  1atk cd1) ← ON_ATTACK: damage+heal
    ...
    'spell_red_002',        // 雙重火球       (cd3) ← ON_SPELL_CAST: damage×2
...
const deck2: DeckDefinition = {
  ...
  cardIds: [
    ...
    'creature_red_003',     // 吸血刺客 ← ON_ATTACK: damage+heal
    'creature_green_001',   // Iron Golem
    'artifact_neutral_002', // Power Gem
    'spell_red_002',        // 雙重火球 ← ON_SPELL_CAST: damage×2
  ],
};
